...
from stats_spec_architect.gui_v2.edge_widgets import AddEdge
from stats_spec_architect.gui_v2.input_widgets import CreateInputWidgets
from stats_spec_architect.gui_v2.node_widgets import AddNode
from stats_spec_architect.gui_v2.scrolled_frame import VerticalScrolledFrame
from stats_spec_architect.gui_v2.utils import CollapsingFrame


def launch_main_gui_v2(layout=None):
    """
    ...
    main_window.title('BIDS Stats Model Architect (v2 - Pydantic)')
...
def _show_json(input_widgets, node_widgets, edge_widgets):
    ...
    from stats_spec_architect.gui_v2.json_export import (
        export_to_json,
        show_json_in_window,
    )
...
def _save_json(input_widgets, node_widgets, edge_widgets):
    ...
    from stats_spec_architect.gui_v2.json_export import export_to_json
...
def _load_json(input_widgets, node_widgets, edge_widgets):
    ...
    from stats_spec_architect.gui_v2.json_import import load_json_to_gui
...
def main():
    ...
    launch_main_gui_v2(layout=None)
