...
Run this to test the transformation widget system in isolation:
    python -m stats_spec_architect.gui_v3.test_transformation_widgets
"""
...
def show_output(transformation_widget):
    ...
    # Get Transformer version (using new simple key format)
    if 'Transformer' in transformation_widget.widget_output:
        output['Transformer'] = transformation_widget.widget_output['Transformer'].get()
